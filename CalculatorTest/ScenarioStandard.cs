...
namespace CalculatorTest
{
    ...
    public class ScenarioStandard : CalculatorSession
    {
        ...
        public static void ClassInitialize(TestContext context)
        {
            ...
            if (!header.Text.Equals("Standard Calculator mode", StringComparison.OrdinalIgnoreCase))
            {
                ...
                Thread.Sleep(TimeSpan.FromSeconds(1));
                Assert.IsTrue(header.Text.Equals("Standard Calculator mode", StringComparison.OrdinalIgnoreCase));
            }
